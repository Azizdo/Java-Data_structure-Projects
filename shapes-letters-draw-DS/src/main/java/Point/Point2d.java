...
public class Point2d extends AbstractPoint {
    ...
    public Point2d rotate(Double[][] rotationMatrix) {
        double x = this.X() * rotationMatrix[0][X] - this.Y() * rotationMatrix[0][Y];
        vector[Y] = this.X() * rotationMatrix[1][X] + this.Y() * rotationMatrix[1][Y];
        vector[X] = x;
        return this;
    }
    ...
    public Point2d rotate(Double angle) {
        ...
        vector[Y] = this.X() * Math.sin(angle) + this.Y() * Math.cos(angle);
        vector[X] = x;
        return this;
    }
     ...
     */
    @Override
    public Point2d clone() { return new Point2d(this.X(), this.Y()); }
}
